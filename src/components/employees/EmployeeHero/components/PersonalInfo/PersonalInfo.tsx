...
import { employees, Employee } from '@/data/mock/employees';
    ...
    return (
        <div className={styles.PersonalInfo}>
            ...
            <div className={styles.infoSection}>
                    ...
                    <span className={styles.value}>{personalInfo?.birthDate}</span>
                    ...
                    <span className={styles.value}>{personalInfo?.phone.mobile}</span>
                    <span className={styles.label}>Раб. телефон</span>
                    <span className={styles.value}>{personalInfo?.phone.work}</span>
